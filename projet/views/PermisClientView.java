...
public class PermisClientView extends JFrame {
    ...
    public PermisClientView(Client client) {
        setTitle("Permis de " + client.getNom());
        setSize(400, 300);
        setLocationRelativeTo(null);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setLayout(new BorderLayout());

        titreLabel = new JLabel("Permis de " + client.getNom(), SwingConstants.CENTER);
